...
div.affinity-front-page, div.entry-content, .site-content .entry-content {
	width:100% !important;
	max-width:100%;
	padding:0 !important;
	margin:0 !important;
...
.byline { width:auto; display:inline; }
.byline .author { 
	width:auto; 
	display: none;
	padding:0 1em 0 0;
...
.winter {
	background:url("/wp-content/uploads/2013/08/winter1_dark.jpg");
	padding:4em 15%;
}
.winter h1 {
	font-size:3em;
...
.site-description-wrapper h4 {
	display:none;
}

section.hosting_events {
	padding-top:4rem;
	padding:4rem 10%;
...
.custom-header-image { background-size: contain}
body {
	background:white; /*url('/wp-content/uploads/2015/10/stars.jpg');*/
...
section.mainPageBullshit { 
  position: relative;
  z-index: 5;
}
.affinity-front-page .custom-header-image {
...
.cta.tickets {
 background-color:rgb(164, 135, 86);
 border-color:rgb(178, 152, 108);
}
